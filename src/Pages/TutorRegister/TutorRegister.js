            ...
            <MDBRow>
              ...
              {this.state.formActivePanel1 === 2 && (
                <MDBCol md="12" className="contribution-add-location">
                  ...
                  <MDBInput label="Exam/Degree title" outline />
                  <MDBInput label="Group" outline />
                  <MDBInput label="Institute Name" outline />
                  <MDBInput label="Result" outline />
                  <MDBInput label="Year of passing" outline />
                  <MDBBtn
                    rounded
              ...
              {this.state.formActivePanel1 === 3 && (
                <MDBCol md="12" className="contribution-add-location">
                  ...
                  <MDBInput
                    label="What is your total tutoring experience?"
                    outline
                  />
                  <MDBInput
                    type="textarea"
                    label="Please describe your tuition experience details-"
                    rows="3"
                    outline
                  />
                  <MDBBtn
